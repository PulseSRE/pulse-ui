...
OpenShift Pulse — a React/TypeScript dashboard for OpenShift Day-2 operations. All data comes from live Kubernetes APIs (no mock data in production code). v2.17.0, ~200 source files, 2,128 unit tests (175 files) + 57 E2E scenarios.
...
- **Agent version**: v2.17.0 (Protocol v2, 104 native tools + MCP, 27 scanners)
