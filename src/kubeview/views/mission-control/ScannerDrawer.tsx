...
const SCANNER_INFO: Record<string, { description: string; autoFixable?: boolean; severity: string }> = {
  ...
  trend_memory: { description: 'Predicts node memory exhaustion within 3 days from 7-day trends', severity: 'warning' },
  trend_disk: { description: 'Predicts volume capacity exhaustion within 7 days from 7-day trends', severity: 'warning' },
  trend_hpa: { description: 'HPAs running near maximum capacity for 48 hours — scaling headroom is gone', severity: 'warning' },
  trend_errors: { description: 'HTTP 5xx rates accelerating over 24 hours', severity: 'warning' },
  slo_burn: { description: 'Registered SLOs burning error budget faster than the target allows', severity: 'critical' },
