        ...
        <div className="flex items-center gap-2">
          {isTerminal && !isDelete && (
            <button onClick={() => go(`/r/apps~v1~deployments/${namespace}/${name}`, name)}
              className="flex items-center gap-1 px-3 py-1.5 text-xs bg-blue-600 hover:bg-blue-500 text-white rounded-sm">
        ...
        <div className="px-4 py-2 border-b border-slate-800">
          ...
          <div className="space-y-1">
            {pods.map((pod) => {
              ...
              return (
                <div key={pod.metadata.uid} className="flex items-center justify-between py-1 px-2 rounded-sm hover:bg-slate-800/50">
                  <div className="flex items-center gap-2">
